...
# eleccionar una posició en l'escala cada 4, amb modul
for i, pitch in enumerate(scale):
    if i % 4 == 0:             
...
# modificar el caràcter en temps d'execució amb el mouse o teclat
...
# usar data emmagatzemada en un fitxer
